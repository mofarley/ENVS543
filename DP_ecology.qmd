...
-   Before the switch (low knob setting):

    -   State A is stable and the population tends to stay low.

    -   State B is unstable - if the population gets too high, something (like lack of food) will cause it to crash back down.

-   After the switch (high knob setting):

    -   State B is now stable - the population tends to stay high.
...
![](images/Shortest_path_Dijkstra_vs_BellmanFord.gif)
...
-   Follow the damn directions/prompt!!!
